  ...
  <div class="payment-container">
    ...
    <div class="summary-section">
      <div class="logo-section">
        <img
          src="/src/assets/images/Beige_And_Red_Handwritten_Typographic_Clothing_Brand_Logo__1_-removebg-preview (1).png"
          alt="Company Logo"
        />
      </div>
    ...
    <div v-if="isPaymentSuccessful" class="modal-overlay">
      <div class="modal">
...
export default {
  data() {
    return {
      ...
      cardBrand: "Unknown",
      cartProduct: [
        { id: 1, name: "Nike Dunks Low", price: 1899 },
        { id: 2, name: "Adidas Yeezy", price: 2500 },
      ],
      isPaymentSuccessful: false, // Controls the visibility of the modal
    };
  },
  computed: {
    total() {
  ...
  methods: {
    async processPayment() {
      if (this.validateShippingAddress() && this.validateCard()) {
        try {
          ...
          const checkoutResponse = await fetch('http://localhost:3500/checkouts/checkouts', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
    ...
    closeModal() {
      this.isPaymentSuccessful = false; // Hide the modal
    },
  },
};
</script>
